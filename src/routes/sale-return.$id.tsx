  ...
  return (
    <div className="flex flex-col h-full bg-gray-100">
      <div className="no-print bg-white border-b px-5 py-3 flex items-center justify-between gap-3">
        ...
        >
          <ArrowLeft className="h-4 w-4" /> Back to Sale Returns
        </button>
        <div className="flex items-center gap-3">
          <div className="text-center">
            <p className="text-[11px] text-gray-400">Credit Note</p>
        ...
        >
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="text-right">
              <div className="inline-block bg-amber-50 border-2 border-amber-300 rounded-lg px-5 py-3">
          ...
          <div className="flex justify-end mb-6">
            <div className="w-72 space-y-1.5 text-sm">
              ...
              <div className="flex justify-between items-center pt-2 mt-1 border-t-2 border-gray-800 font-bold text-[18px]">
                ...
                <span className="tabular-nums text-amber-600">{fmtMoney(ret.total)}</span>
              </div>
            </div>
          </div>
